          ...
          <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
              ...
              >
                ...
                />
                <span class="ml-1"
                  >Samuel <i class="mdi mdi-chevron-down"></i>
                </span>
              </a>
            ...
            <div class="row">
              <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card-box tilebox-one">
                  ...
                  <span class="text-muted ml-2 vertical-middle"
              ...
              <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                <div class="card-box tilebox-one">
                  ...
                  <span class="text-muted ml-2 vertical-middle">Last year</span>
                </div>
              </div>
            </div>
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      <div class="text-center mt-3">
                        <h6 class="font-normal text-muted font-14">
                          Conversion Rate
                        </h6>
                        <h6 class="font-18">
                          <i
                      ...
                      <div class="text-center mt-3">
                        ...
                        <h6 class="font-18">
                          <i
                            class="mdi mdi-arrow-up-bold-hexagon-outline text-success"
                          ></i>
                          <span class="text-dark">25.87</span>
                          <small>USD</small>
                        </h6>
                      </div>
                    </div>
                      ...
                      <div class="text-center mt-3">
                        ...
                        <h6 class="font-18">
                          <i
                            class="mdi mdi-arrow-up-bold-hexagon-outline text-success"
                          ></i>
                          <span class="text-dark">87,4517</span>
                          <small>USD</small>
                        </h6>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <div class="text-center mt-3">
                        ...
                        <h6 class="font-18">
                          <i
                            class="mdi mdi-arrow-down-bold-hexagon-outline text-danger"
                          ></i>
                          <span class="text-dark">16.25</span>
                          <small>USD</small>
                        </h6>
                      </div>
                    </div>
                      ...
                      <div class="text-center mt-3">
                        ...
                        <h6 class="font-18">
                          <i
                            class="mdi mdi-arrow-up-bold-hexagon-outline text-success"
                          ></i>
                          <span class="text-dark">124,858.67</span>
                          <small>USD</small>
                        </h6>
                      </div>
                    </div>
            ...
            <div class="row">
                    ...
                    <a href="#">
                      <div class="inbox-item">
                        <div class="inbox-item-img">
                          <img
                            src="assets/images/users/avatar-1.jpg"
                            class="rounded-circle bx-shadow-lg"
                            alt=""
                          />
                        </div>
                  ...
                  >
                    <a href="#">
                      <div class="comment-box-item">
                        ...
                        <h6 class="commnet-item-msg">
                          Do you have any plans to add a vertical menu?
                        </h6>
                    ...
                    <a href="#">
                      <div class="comment-box-item">
                        ...
                        <p class="commnet-item-date">1 month ago</p>
                        <h6 class="commnet-item-msg">
                          Hello, what is your plan to upgrade Bootstrap 4
                          versions? Beta or wait for stable?
                        </h6>
                        <p class="commnet-item-user">Ubold User</p>
                      </div>
                    </a>
                    <a href="#">
                      <div class="comment-box-item">
                        ...
                        <p class="commnet-item-date">1 month ago</p>
                        <h6 class="commnet-item-msg">
                          Hi coderthemes – do you have PSD for this admin UI? I
                          could really use it.
                        </h6>
                        <p class="commnet-item-user">Ubold User</p>
                      </div>
              ...
              <div class="col-lg-4">
                <div class="card-box">
                  ...
                  <ul
                    class="list-unstyled transaction-list slimscroll mb-0"
                    style="max-height: 370px"
                  >
                    <li>
